...
app.post('/planner', async function (req, res) {
    ...
    let sql = 'INSERT INTO planner (id, destination, date, km, description, userid) VALUES(DEFAULT, $1, $2, $3, $4, $5) RETURNING *';
...
app.post('/listeinnhold', async function (req, res) {
    ...
    let sql = 'INSERT INTO listeinnhold (id, description, amount, plannerid) VALUES(DEFAULT, $1, $2, $3) RETURNING *';
    let values = [updata.descr, updata.amount, updata.plannerid];
